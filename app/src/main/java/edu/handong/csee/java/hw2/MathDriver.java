...
import edu.handong.csee.java.hw2.math.MathCalculator;
    ...
    /**
     * this class is MathDriver which operates MathCalculator class
    */
public class MathDriver {
    /**
     * this main method runs the main code and makes an instance of Mathdriver class
     * @param args this parameter got a driver name and input numbers for running
     * 
    */
    ...
    /**
     * this run method got a order of calculate and print the answer of input value
     * @param args this parameter got a driver name and the input numbers
    */
